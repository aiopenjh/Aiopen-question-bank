...
4. [매력적인 오답 선지 (Plausible Distractor)]: 3개의 오답 선지는 지어낸 허구의 단어가 아니라, 수험자가 실제로 혼동하기 쉬운 인접 개념이나 전형적인 오개념을 활용하여 설계하고, distractorRationale에 수험자가 왜 이 선지를 오답으로 착각했는지 이유를 적시하십시오.
5. [지식 굳히기용 1~2줄 핵심 개념 정의 (conceptDefinition)]: 찍어서 맞힌 수험자도 10초 만에 완벽히 머릿속에 각인할 수 있는 "공인 교과서/기술 레퍼런스 기준의 핵심 개념 및 공식 정의"를 명확히 작성하십시오.
6. [명쾌한 출제 근거 팩트 (explanation)]: 정답인 이유와 함께 반드시 "[출제 근거 팩트: ...]"를 명쾌하게 서술하십시오.
7. [맞춤형 역추론 힌트 (deepReasoningHint)]: 오답을 선택한 학습자가 스스로 생각하여 정답을 유추할 수 있는 결정적 원리 힌트를 제공하십시오.
...
[출력 JSON 스키마 규격]
{
  "questions": [
    {
      "stem": "문제 지문",
      "conceptDefinition": "핵심 개념 및 용어/공식의 명확한 1~2줄 정의 (지식 굳히기용)",
      "options": [
        { "text": "선지 1", "distractorRationale": "오답인 이유" },
        { "text": "선지 2", "distractorRationale": "오답인 이유" },
        { "text": "선지 3", "distractorRationale": "" },
        { "text": "선지 4", "distractorRationale": "오답인 이유" }
      ],
      "correctIndex": 2,
      "explanation": "정답 해설 및 [출제 근거 팩트]",
      "deepReasoningHint": "오답 선택자를 위한 역추론 힌트"
    }
  ]
}`;
