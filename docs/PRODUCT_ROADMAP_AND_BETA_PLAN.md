...
| **Step 1** | 랭킹 시스템 완성 | 순차 도전 포함 main 반영, 서버 운영 방식은 추후 결정 | **로컬 기능 완료** |
| **Step 2** | 수학 풀이공간 (Scratchpad) | CBT 화면 내 인앱 터치 드로잉 캔버스 컴포넌트 탑재 | 기능 브랜치 검증 중 |
| **Step 3** | 주관식 & 밑줄/빈칸 엔진 | 4지선다 외 단답형·빈칸형 생성, 의미 기반 부분점수 채점기 | 기능 브랜치 검증 중 |
